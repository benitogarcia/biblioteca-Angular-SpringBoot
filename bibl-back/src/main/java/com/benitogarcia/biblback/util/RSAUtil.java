package com.benitogarcia.biblback.util;
...
public class RSAUtil {
	...
	public static String encryptPublicKey(String data) throws BadPaddingException, IllegalBlockSizeException,
	...
	public static String encryptPrivateKey(String data) throws BadPaddingException, IllegalBlockSizeException,
			InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException {
		Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
		cipher.init(Cipher.ENCRYPT_MODE, getPublicKey(publicKey));
		return Base64.getEncoder().encodeToString(cipher.doFinal(data.getBytes()));
	...
	/*public static void main(String[] args)
		...
		try {
			// String encryptedString = Base64.getEncoder().encodeToString(encrypt("Dhiraj
			// is the author", publicKey));
